...
{
    /**
     * Prepare info about discount rules of products within the loop
     */
    ...
    /**
     * Replace price view for variable products within the loop
     *
     */
    ...
    /**
     * Replace price view for other products within the loop
     *
     */
    ...
    /**
     * Substitute value of the sale price within the loop
     *
     */
    ...
    /**
     * Substitute boolean is-on-sale original state of product
     *
     */
    ...
    /**
     * Replace sale flash view within the loop.
     *
     */
...
/**
 * Integration rules work within the product page
 *
 */
function do_vtprd_product_page_integrations()
{
    ...
    /**
     * Prepare info about discount rules of products within the product page
     */
    ...
    /**
     * Replace sale flash view within the product page.
     *
     */
    ...
    /**
     * Substitute boolean is-on-sale original state of product within the product page
     *
     */
    ...
    /**
     * Replace original value of regular price within the product page
     *
     */
    ...
    /**
     * Substitute value of the sale price within the product page
     *
     */
    ...
    /**
     * Replace price view for other products within the product page
     *
     */
    ...
    /**
     * Substitute value of variation regular price within the product page
     *
     */
    ...
    /**
     * Substitute value of variation sale price within the product page
     *
     */
...
/**
 * Recieves data on product discounts.
 *
 * Auxiliary function. Apply discount rules, emulating cart in order to use
 * native plugin function for check products for discounts.
 */
